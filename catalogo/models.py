...
class Producto(models.Model):
    ...
    def crear_variaciones(self,user):
        ...
        llaves = self.variaciones.all().values('llave').order_by('llave').distinct().count()
...
class Categoria(models.Model):
    ...
    padre = models.ForeignKey("Categoria",related_name="categoria_padre", null=True, blank = True, on_delete=models.CASCADE)
